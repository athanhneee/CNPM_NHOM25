...
export async function seedDemoData(client: PrismaClient, options: { reset?: boolean } = {}) {
  ...
  await client.enrollment.createMany({
    data: [
      ...
      { id: 'enr-n23dccn002-int205', studentId: 'N23DCCN002', sectionId: 'sec-int205-1', semesterId: currentSemesterId, status: 'REGISTERED', timeline: [{ status: 'REGISTERED', timestamp: '2026-04-10T08:01:00Z', actorId: 'N23DCCN002', actorRole: 'STUDENT', note: 'Đăng ký thành công.' }] },
