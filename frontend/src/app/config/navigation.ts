...
export const navigationGroups: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'key-round',
        roles: ['STUDENT', 'LECTURER', 'ACADEMIC_OFFICE', 'ADMIN'],
        description: 'Thay đổi mật khẩu mô phỏng cho phiên đăng nhập hiện tại.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'calendar-days',
        roles: ['STUDENT'],
        description: 'Xem lịch học theo dạng lưới tuần.',
      },
      {
        label: 'TKB học kỳ',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'calendar-range',
        roles: ['LECTURER'],
        description: 'Lịch giảng dạy trong tuần hiện tại.',
      },
      {
        label: 'TKB học kỳ',
